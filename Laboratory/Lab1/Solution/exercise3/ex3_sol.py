...
if __name__ == '__main__': # starts main
    ...
    for line in f:
        ...
        name, surname, city, date = line.split() # insert fileds in the corresponding variables, splitting with " " as separator
        day, month, year = date.split('/')
        month_int = int(month) # cast string to int
